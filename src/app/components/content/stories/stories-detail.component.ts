...
export class StoriesDetailComponent {
    ...
    public organisation_link: string;
        ...
        router.events.forEach((event) => {
            if (event instanceof NavigationEnd) {
                if (event.url == '/stories/cre8te-opportunites') {
                    ...
                    this.organisation_link = '/signatories/cre8te-opportunities-limited';
                    ...
                    this.organisation_link = '/signatories/glasgow-life';
                    this.illustration = 'WEB-Skill-Up-(Creating).png';
